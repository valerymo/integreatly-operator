...
import (
	"context"
	"encoding/json"
	v1alpha12 "github.com/integr8ly/cloud-resource-operator/apis/integreatly/v1alpha1"
	"testing"
...
func getBuildScheme() (*runtime.Scheme, error) {
	...
	err = v1alpha12.SchemeBuilder.AddToScheme(scheme)
	if err != nil {
		return scheme, err
	}
