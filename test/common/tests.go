...
var (
	...
	HAPPY_PATH_TESTS = []TestSuite{
		...
		{
			[]TestCase{
				{"E09 - Verify customer dashboards exist - Observability", TestIntegreatlyCustomerDashboardsExistObservability},
		...
		},
		{
			[]TestCase{
				...
				{"C04 - Verify Alerts exist", TestIntegreatlyAlertsExistObservability},
				{"E01 - Verify Middleware Grafana Route is accessible", TestGrafanaExternalRouteAccessibleObservability},
				{"E02 - Verify that all dashboards are installed and all the graphs are filled with data - Observability", TestDashboardsDataObservability},
				{"E03 - Verify middleware dashboards exist", TestIntegreatlyMiddelewareDashboardsExistObservability},
				/*FLAKY on RHMI/RHOAM*/ {"E05 - Verify Grafana Route returns dashboards", TestGrafanaExternalRouteDashboardExistObservability},
	...
	IDP_BASED_TESTS = []TestSuite{
		{
			[]TestCase{
				...
				{"C19 - Validate creation of invalid username triggers alert", TestInvalidUserNameAlertObservability},
